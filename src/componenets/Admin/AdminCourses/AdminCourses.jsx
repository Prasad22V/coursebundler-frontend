...
const AdminCourses = () => {
  ...
  const [loadingCourses, setLoadingCourses] = useState(false); // Local loader state
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      setLoadingCourses(true); // Start loader
      await dispatch(getAllCourses());
      setLoadingCourses(false); // Stop loader
    };
  ...
  return (
    ...
    >
      {loadingCourses ? ( // Show loader when fetching courses
