...
const PaymentSuccess = () => {
  ...
  const referance = useSearchParams()[0].get("reference")
// console.log(search);
  ...
  return (
    <Container h="90vh" p="16">
      ...
      <VStack boxShadow={'lg'} pb="16" alignItems={'center'} borderRadius="lg">
        ...
        <Link to="/profile">
          <Button variant={'ghost'} backgroundColor={'gray'}>Go to profile</Button>
        </Link>

        <Heading size={'xs'}>Reference:{referance}</Heading>
      </VStack>
    </Container>
  )
}
